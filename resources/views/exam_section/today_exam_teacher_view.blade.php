  ...
  <div class="row d-flex justify-content-center" style="width: 100%; margin-top:1cm">
    ...
    <div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
        <div class="list-group w-100">  
          ...
          <button class="btn btn-secondary" style="float:left">edit exam details</button>
          <a href="{{url('/endexam',$exam->id)}}"><button class="btn btn-danger" style="float:right">end exam</button></a>
      </div>
      </div>
    </div>
  </div>
