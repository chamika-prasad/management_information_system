...
<li><div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
  ...
  <div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
      <div class="list-group w-100">  
        ...
        <a href="{{url('/show_today_exam_detail',$item['id'])}}" style="text-decoration: none; color:black;"><div class="d-flex w-100 justify-content-between" style="padding-top:10px">
