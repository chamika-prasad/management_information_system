...
<head>
    ...
    <title>select_module_attendance</title>
</head>
...
<body>
    ...
    <div class="container-fluid form" style="width: 85%;">
        ...
        <form action="/attendance" method="POST">
                      ...
                      <div class="row">
                          ...
                          <div class="col-3 form-group"  >
                                <select class="form-control" id="select_grade" style="width: 50%; background-color:#04a369; color:white;" name="stu_name1">
                                    <option value="0" selected disabled><p>select grade</p></option>
            ...
            <div class="col mt-4">
                <button class="btn btn-danger" type="submit" name="attendance" style="font-size: 1.5rem; float:right; ">continue</button>
            </div>
        </form>
        <hr>
