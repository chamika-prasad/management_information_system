...
<li><div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
  ...
  <div class="row d-flex justify-content-center" style="width: 100%">
    <div class="card col-md-10" style="background-color: #6b7e51">
      <div class="card-body">
        ...
        <h3>subject name / exam name / answers </h3>
  ...
  <tbody>
    <tr>
      ...
      <td>{{$answer['answer']}}</td>
      <td><a href="{{url('views',$answer['answer'])}}"><span>view<span></a> or <a href="{{url('downloaded',$answer['answer'])}}"><span>download<span></a></td>  
      <td>{{$answer['marks']}}</td>
      <td><a href="{{url('addmark',$answer['id'])}}">Add or Modify marks</a></td>
    </tr>
  </tbody>
  @endforeach
</table>
