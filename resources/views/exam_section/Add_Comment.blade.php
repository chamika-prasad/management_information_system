...
<div class="row d-flex justify-content-center" style="width: 100%">
  ...
  <div class="list-group w-100">
    {{-- <div class="list-group-item list-group-item-action"> --}}
      ...
      <div class="mb-1">
        <form action="{{url('/submitcomment',[$user_questions->id,13])}}">
        <textarea class="form-control" type="text" placeholder="Leave Answer here.." name="comment" style="height:1.8cm"></textarea><br>
