    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-hand-index-thumb" viewBox="0 0 16 16" style=" vertical-align: middle; color: black;">
          ...
          <span  style="font-size:30px; vertical-align: middle;  color: white;">&ensp;Quection bank</span> </a>
      </li>
...
{{-- --------------teacher--------------- --}}
      ...
      <a class="nav-link" href="#">
        ...
        <span  style="font-size:30px; vertical-align: middle;  color: white; margin-left:800px;">&ensp;Teachers Mode</span> </a>
      </li>  
    </ul>
</nav>
...
<li><div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
  ...
  <h1 style ='margin-left:3.3cm; padding-bottom:0.5cm'>{{$subject}}</h1>
  ...
  <div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
      <div class="list-group w-100">  
        ...
        <a href="{{url('/show_student_today_exam_detail',[$item['id'],$id])}}" style="text-decoration: none; color:black;"><div class="d-flex w-100 justify-content-between" style="padding-top:10px">
          <h5 class="mb-1">{{$item['description_about_exam']}}</h5>
              <p>{{$item['date_and_time']}}</p>
          </div></a>
        </div>
        @endforeach
        <br>
  ...
  <div class="row d-flex justify-content-center" style="width: 100%; margin-top:1cm;">
    ...
    <div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
        <div class="list-group w-100">  
          <div  data-mdb-toggle="collapse" aria-expanded="false" aria-controls="shortExampleAnswer1collapse" class="form-control">
          <a href="{{url('/show_upcoming_exam_detail',$item['id'])}}" style="text-decoration: none; color:black;"><div class="d-flex w-100 justify-content-between" style="padding-top:10px">
          <h5 class="mb-1">{{$item['description_about_exam']}}</h5>
              <p>{{$item['date_and_time']}}</p>
          </div></a>
          </div>
  ...
  <div class="row d-flex justify-content-center" style="width: 100%; margin-top:1cm; margin-bottom:1cm">
    <div class="card col-md-10" style="background-color: #6b7e51">
      <div class="card-body">
  ...
  <div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
      <div class="list-group w-100">  
        <div  data-mdb-toggle="collapse" aria-expanded="false" aria-controls="shortExampleAnswer1collapse" class="form-control">
        <a href="{{url('/show_finished_exam_detail',$item['id'])}}" style="text-decoration: none; color:black;"><div class="d-flex w-100 justify-content-between" style="padding-top:10px">
          <h5 class="mb-1">{{$item['description_about_exam']}}</h5>
              <p>{{$item['date_and_time']}}</p>
          </div></a>
        </div>
