...
<body>
  ...
  <nav class="navbar navbar-expand-sm " style="background-color: #7C5D5D;">
    ...
    <ul class="navbar-nav">
      ...
      <a class="nav-link" href="#">
        ...
        <span  style="font-size:30px; vertical-align: middle;  color: white; margin-left:600px; ">&ensp;Teacher Mode</span> </a>
    </li>
  ...
  <div class="container-fluid" style="width: 80%">
    ...
    <h4 class="mt-5" > Budhdha Charithaya/Add Exam </h4> 
    ...
    <div class="ml-5">
      ...
      <div class="d-flex justify-content-start">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt-cutoff mt-2" viewBox="0 0 16 16">
        ...
        <a style="color: rgb(17, 6, 6); text-decoration:none;" href="{{url('/add_exam')}}">
          <p class="p-2">Exam</p>
        </a>
      </div>
      <div class="d-flex justify-content-start">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-ruled mt-2" viewBox="0 0 16 16">
          <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V9H3V2a1 1 0 0 1 1-1h5.5v2zM3 12v-2h2v2H3zm0 1h2v2H4a1 1 0 0 1-1-1v-1zm3 2v-2h7v1a1 1 0 0 1-1 1H6zm7-3H6v-2h7v2z"/>
        </svg>
        <p class="p-2">Guidlines</p>
      </div>

    </div>

    <button type="button" class="btn btn-secondary btn-lg btn-block mb-3 mt-3" style="background-color: #6b7e51">Quection Bank</button>

  <!-- card--> 
  
    <div class="card">
      <div class="card-body"  style="background-color: #6b7e51">
        <h3> January 22 </h3>
        <h6> <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-link" viewBox="0 0 16 16">
