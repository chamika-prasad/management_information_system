...
<head>
    ...
    <title>payment_successfull</title>
</head>
<body>
    <!-- navbar 1-->
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">
          ...
          <span  style="font-size:30px; vertical-align: middle;  color: white;">&ensp;Online Payment</span> </a>
      </li>
      ...
      <div class="row h-100 justify-content-center align-items-center">
          <div class="col-10 col-md-8 col-lg-6">
              ...
              <div class = 'card p-5' style="background-color: #b6acab" >
                ...
                <div>
                    <p><span class="font-weight-bold">NOTE :</span> YOUR PAYMENT IS SUCCESSFULL..CHECK YOUR &nbsp;&nbsp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;WHATSAPP FOR RECIPT..</p>
                </div>
