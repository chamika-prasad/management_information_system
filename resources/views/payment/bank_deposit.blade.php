          ...
          <div class="col-10 col-md-8 col-lg-6">
              ...
              <div class = 'card p-5' style="background-color: #b6acab" >
                ...
                <div class = 'card ' style="background-color: black; opacity : 0.4;">
                    <div class="text-center" style="padding-top: 0.5cm; padding-bottom: 0.5cm; color :azure; font-weight:bold;">
                    <div>Account No : XXXX XXXX XXXX XXXX</div>
                    <div>Name : H.P.C.Prasad</div>
                    <div>Bank : BOC</div>
                    <div>Branch : Anuradhapura</div>
                    </div>
                </div>
                <!-- bank details -->
