...
<div class="row d-flex justify-content-start body col-sm-12" style="margin-left: 2.9cm">
  ...
  <div class="row d-flex justify-content-center" style="width: 100%">
    <div class="card col-md-10" style="background-color: #6b7e51">
      <div class="card-body">
        <div class="row ">
        <h4 class=""> Quection bank </h4>
        <div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
          &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
          &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>

        <form action="{{url('/Quection_bank_add',$studentID)}}">
          @csrf
          <input class="btn btn-secondary " type="submit" value="Add Question" style="border: solid;">
       </form>
      </div>
  ...
  <div class="list-group w-100">
    <div data-mdb-toggle="collapse" aria-expanded="false"
      aria-controls="shortExampleAnswer1collapse" class="form-control">
      <div class="d-flex w-100 justify-content-between">
        <h5 class="mb-1">{{$questionList->question_title}}</h5>
      </div>
      
      <p class="mb-1">
        @php
        $arr=str_split($questionList->question,20);
        echo $arr[0];
      ...
      <a href="{{url('/View_student_question',[$questionList->id,13])}}"><small><u>Show more</u></small></a>
      <!-- Collapsed content -->
    </div>
