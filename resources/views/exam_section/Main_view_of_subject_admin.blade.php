...
<body>
  ...
  <nav class="navbar navbar-expand-sm " style="background-color: #7C5D5D;">
    ...
    <ul class="navbar-nav">
      ...
      <li><div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</div>
        ...
        <span  style="font-size:30px; vertical-align: middle;  color: white; margin-left:950px; ">&ensp;Teacher Mode</span> </a>
    </li>
  ...
  <div class="container-fluid" style="width: 80%">
    ...
    <button type="button" class="btn btn-secondary btn-lg btn-block mb-3 mt-3" style="background-color: #6b7e51">
      <a style="color: white; text-decoration:none;" href="{{url('/add_exam')}}">
        <p class="p-2">Exam</p>
      </a>
    </button>
    <button type="button" class="btn btn-secondary btn-lg btn-block mb-3 mt-3" style="background-color: #6b7e51">
      <a style="color: white; text-decoration:none;" href="{{url('/add_quiz')}}">
        <p class="p-2">Quiz</p>
      </a>
    </button>
    <button type="button" class="btn btn-secondary btn-lg btn-block mb-3 mt-3" style="background-color: #6b7e51">
      <a style="color:white; text-decoration:none;" href="{{url('/add_exam')}}">
        <p class="p-2">Quection Bank</p>
      </a>
    </button>
