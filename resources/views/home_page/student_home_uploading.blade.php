    ...
    @include('layouts.StudentNavbar')
     ...
     <nav class="navbar navbar-expand-sm " style="background-color: #7C5D5D;">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" style="link-decoration:none" href="{{url('/teacher_home_uploading')}}">
      ...
      <div>
        <div class="container-fluid" style="width: 85%; padding-bottom: 20px ;padding-top: 20px;">
            <div class="card-deck" >
                ...
                <div class="card border-secondary mb-3 bg-secondary text-white" style="text-align: center">
                    <a href="{{url('/Student_Quection_bank_list',13)}}">
                        <button class="btn btn-secondary" >
                            <div class="card-body">
                                <h5 class="card-title">Question Bank</h5>
                                <p class="card-text">Find Answers For Your Questions</p>
                            </div>
                        </button>
                    </a>
                </div>
